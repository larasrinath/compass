...
This document preserves the implementation notes and dated acceptance records
previously in the root README. For current setup and user workflows, see the
[README](../README.md); for delivery scope, see [PROJECT_PLAN.md](../PROJECT_PLAN.md).
Historical milestone counts and acceptance results are not claims about a new live run.

## Implementation and historical acceptance
